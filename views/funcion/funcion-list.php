...
if (isset($_POST['eliminar'])) {
	$fun->delete($_POST["codigo"]);
}

if (isset($_POST['crear'])) {
    $fun->create($_POST["codigo"], $_POST["fecha"], $_POST["codigoPelicula"],$_POST["codigoSala"]);
}

$arr = $fun->listar($con->conectar());
?>
<!DOCTYPE html>
<html lang="es">
		...
		<section class="full-box page-content">
			...
			<div class="container-fluid">
				<ul class="full-box list-unstyled page-nav-tabs">
					...
					<li>
						<a class="active" href="./funcion-list.php"><i class="fas fa-clipboard-list fa-fw"></i> &nbsp; LISTA DE FUNCIONES</a>
					</li>
					<li>
						<a href="../peliculas/pelicula-list.php"><i class="fas fa-clipboard-list fa-fw"></i> &nbsp; LISTA DE PELICULAS</a>
					</li>
						...
						<tbody>
							...
							?>
								<tr class="text-center">
									...
									<td><?php echo $arr[$i]['codigoPelicula'] ?></td>
									<td><?php echo $arr[$i]['codigoSala'] ?></td>
									<td>
