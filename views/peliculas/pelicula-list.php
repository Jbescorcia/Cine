...
$con = new conexion();
$pel = new pelicula($con->conectar());


if (isset($_POST['eliminar'])) {
	$pel->delete($_POST["clasificacion"],$_POST["codigo"]);
}

if (isset($_POST['crear'])) {
	$pel->create($_POST["nombre"], $_POST["codigo"], $_POST["clasificacion"]);
}

$arr = $pel->listar($con->conectar());
?>
	...
	<main class="full-box main-container">
		...
		<section class="full-box page-content">
			...
			<div class="full-box page-header">
				<h3 class="text-left">
					<i class="fas fa-clipboard-list fa-fw"></i> &nbsp; LISTA DE PELICULAS
				</h3>
			...
			<ul class="full-box list-unstyled page-nav-tabs">
					...
					<li>
						<a class="active" href="../peliculas/pelicula-list.php"><i class="fas fa-clipboard-list fa-fw"></i> &nbsp; LISTA DE PELICULAS</a>
					</li>
					<li>
                        <a href="../salas/sala-list.php"><i class="fas fa-clipboard-list fa-fw"></i> &nbsp; LISTA DE SALAS</a>
                    </li>
								...
								<tr class="text-center">
									...
									<td>
										<form method="post" action="">
											<input type="hidden" name="clasificacion" value="<?php echo $arr[$i]['clasificacion'] ?>">
